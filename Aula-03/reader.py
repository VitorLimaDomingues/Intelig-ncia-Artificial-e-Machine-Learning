...
def extrair_texto_pdf(caminho_arquivo):
    """
    Abre o PDF do formulário de viagem do cliente e extrai todo o texto contido nele.
    Parâmetros:
        caminho_arquivo (str): O caminho para o arquivo PDF do cliente.
    Retorna:
    ...
    try:
        ...
        # Retorna o texto completo extraído do formulário
